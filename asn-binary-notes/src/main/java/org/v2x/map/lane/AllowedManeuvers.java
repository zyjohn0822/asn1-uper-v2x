...
public class AllowedManeuvers implements IASN1PreparedElement {
    ...
    private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(AllowedManeuvers.class);
    @Override
