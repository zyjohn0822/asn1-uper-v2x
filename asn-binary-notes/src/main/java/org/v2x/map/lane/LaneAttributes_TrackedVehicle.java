...
public class LaneAttributes_TrackedVehicle implements IASN1PreparedElement {
    ...
    private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(LaneAttributes_TrackedVehicle.class);
    @Override
