...
public class SignalPhaseAndTiming extends AsnModule {
    ...
    public final static SignalPhaseAndTiming instance = new SignalPhaseAndTiming();


    /**
     * /* Creates the ASN.1 module.
     * /* The ASN.1 module instance is created automatically, clients must not call.
     * /* A metadata file named SignalPhaseAndTiming.meta must exist in the same package of this class.
     **/
