...
public class PathHistoryPointList {
    ...
    public final static AsnType TYPE = VehSafetyExt.type(327735);
    public final static AsnConverter CONV = new VectorConverter(PathHistoryPoint.CONV);

    public static void ber_encode(Vector<PathHistoryPoint> object, OutputStream out) throws IOException {
        TYPE.encode(object, EncodingRules.BASIC_ENCODING_RULES, CONV, out);
    }

    public static Vector<PathHistoryPoint> ber_decode(InputStream in) throws IOException {
        return (Vector<PathHistoryPoint>) TYPE.decode(in, EncodingRules.BASIC_ENCODING_RULES, CONV);
    }
    ...
    public static Vector<PathHistoryPoint> per_decode(boolean align, InputStream in) throws IOException {
        return (Vector<PathHistoryPoint>) TYPE.decode(in, align ? EncodingRules.ALIGNED_PACKED_ENCODING_RULES : EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
    }
