 ...
 */
package com.hisense.hiatmp.asn.v2x.DefAcceleration;
...
public class DefAcceleration extends AsnModule {
    ...
    public final static DefAcceleration instance = new DefAcceleration();


    /**
     * /* Creates the ASN.1 module.
     * /* The ASN.1 module instance is created automatically, clients must not call.
     * /* A metadata file named DefAcceleration.meta must exist in the same package of this class.
     **/
