...
public enum BrakeBoostApplied {
    ...
    public final static AsnType TYPE = MsgFrame.type(524322);
    ...
    public static BrakeBoostApplied valueOf(int value) {
        BrakeBoostApplied[] values = values();
    ...
    public static BrakeBoostApplied ber_decode(InputStream in) throws IOException {
        return (BrakeBoostApplied) TYPE.decode(in, EncodingRules.BASIC_ENCODING_RULES, CONV);
    }

    public static BrakeBoostApplied per_decode(boolean align, InputStream in) throws IOException {
        return (BrakeBoostApplied) TYPE.decode(in, align ? EncodingRules.ALIGNED_PACKED_ENCODING_RULES : EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
    }
