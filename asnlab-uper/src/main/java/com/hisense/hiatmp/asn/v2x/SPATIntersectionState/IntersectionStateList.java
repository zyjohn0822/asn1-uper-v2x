...
public class IntersectionStateList {
    ...
    public final static AsnType TYPE = SPATIntersectionState.type(65556);
    public final static AsnConverter CONV = new VectorConverter(IntersectionState.CONV);

    public static void ber_encode(Vector<IntersectionState> object, OutputStream out) throws IOException {
        TYPE.encode(object, EncodingRules.BASIC_ENCODING_RULES, CONV, out);
    }

    public static Vector<IntersectionState> ber_decode(InputStream in) throws IOException {
        return (Vector<IntersectionState>) TYPE.decode(in, EncodingRules.BASIC_ENCODING_RULES, CONV);
    }
    ...
    public static Vector<IntersectionState> per_decode(boolean align, InputStream in) throws IOException {
        return (Vector<IntersectionState>) TYPE.decode(in, align ? EncodingRules.ALIGNED_PACKED_ENCODING_RULES : EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
    }
