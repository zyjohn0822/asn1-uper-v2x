...
public enum AntiLockBrakeStatus {
    ...
    public final static AsnType TYPE = MsgFrame.type(524320);
    ...
    public static AntiLockBrakeStatus per_decode(boolean align, InputStream in) throws IOException {
        return (AntiLockBrakeStatus) TYPE.decode(in, align ? EncodingRules.ALIGNED_PACKED_ENCODING_RULES : EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
    }
