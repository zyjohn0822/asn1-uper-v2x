...
public enum StabilityControlStatus {
    ...
    public final static AsnType TYPE = MsgFrame.type(524321);
    ...
    public static StabilityControlStatus valueOf(int value) {
        StabilityControlStatus[] values = values();
    ...
    public static StabilityControlStatus ber_decode(InputStream in) throws IOException {
        return (StabilityControlStatus) TYPE.decode(in, EncodingRules.BASIC_ENCODING_RULES, CONV);
    }

    public static StabilityControlStatus per_decode(boolean align, InputStream in) throws IOException {
        return (StabilityControlStatus) TYPE.decode(in, align ? EncodingRules.ALIGNED_PACKED_ENCODING_RULES : EncodingRules.UNALIGNED_PACKED_ENCODING_RULES, CONV);
    }
