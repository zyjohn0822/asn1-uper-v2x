...
public class UperEncoderExample2RestrictionTest {
    ...
    public static class PersonenelRecord {
        ...
        Name nameOfSpouse;
        @Asn1Optional
        SequenceOfChildInformation sequenceOfChildInformation = new SequenceOfChildInformation();
    ...
    public static class Name {
        ...
        public Name() {
            this(new NameString(), new NameString(), new NameString());
        }
    ...
    public static class SequenceOfChildInformation extends Asn1SequenceOf<ChildInformation> {
        public SequenceOfChildInformation() {
            super();
        }

        public SequenceOfChildInformation(Collection<ChildInformation> coll) {
            super(coll);
        }
    }
