...
public class UperEncoderStringEncodeDecodeTest {
    ...
    @Test
    public void Utf8StringTest4() throws IllegalArgumentException, IllegalAccessException {
    ...
    @Test
    public void Utf8StringTest5() throws IllegalArgumentException, IllegalAccessException {
        Object pdu = new Utf8TestClass(
    ...
    @Test
    public void Utf8StringTest6() throws IllegalArgumentException, IllegalAccessException {
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < 15; i++) {
            sb.append("1234567890");
        }
